...
#region Helpers
        ...
        public FileContentResult DisplayUserImage()
        {
            ...
            return user.Foto != null ? new FileContentResult(user.Foto, "image/jpeg") : DisplayNoImage();
        }

        public FileContentResult DisplayNoImage()
        {
            var fileName = HttpContext.Server.MapPath(@"~/Content/img/noImg.png");
